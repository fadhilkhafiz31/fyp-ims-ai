...
app.post("/detect-intent", async (req, res) => {
  try {
    ...
    // Custom intent matching used to live here but ChatbotPanel now just relays Dialogflow's
    // own fulfillment text, so this returns that directly instead of re-scoring matches.
